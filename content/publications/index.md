...
<div style="padding:12px 14px;margin:14px 0;border:1px solid #e6e6e6;border-left:6px solid #bbb;border-radius:8px;background:#f7fafc">
  ...
  <div style="margin-top:.35rem">
    ...
    <span style="margin:0 .35rem">·</span>
    <a href="/demos/edtec-itemgen/" style="display:inline-block;padding:.15rem .5rem;border-radius:.35rem;background:#eef2ff;text-decoration:none;color:inherit;user-select:none">Code</a>
    <span style="margin:0 .35rem">·</span>
...
<div style="padding:12px 14px;margin:14px 0;border:1px solid #e6e6e6;border-left:6px solid #bbb;border-radius:8px;background:#f7fafc">
  ...
  <div style="margin-top:.35rem">
    ...
    <span style="margin:0 .35rem">·</span>
    <a href="/demos/edtec-qbuilder/" style="display:inline-block;padding:.15rem .5rem;border-radius:.35rem;background:#eef2ff;text-decoration:none;color:inherit;user-select:none">Code</a>
    <span style="margin:0 .35rem">·</span>
